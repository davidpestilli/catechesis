/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/src/cloudflare-env.d.ts --config worker/wrangler.jsonc` (hash: ac022f5af32b63fcfdb3ae60a429cad5)
// Runtime types generated with workerd@1.20260603.1 2026-06-09 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,https://davidpestilli.github.io";
	SUPABASE_STORAGE_BUCKET: "catechesis-media";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "SUPABASE_STORAGE_BUCKET" | "VITE_SUPABASE_URL" | "VITE_SUPABASE_ANON_KEY" | "VITE_SUPABASE_SERVICE_ROLE_KEY">> {}
}
