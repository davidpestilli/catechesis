...
export function buildThreadSubscriptionSubject(input: ThreadSubscriptionEmailTemplateInput) {
  return `Você está acompanhando a conversa em ${input.contentTitle} | ${input.siteName}`
}
      ...
      <body style="margin:0;padding:32px 16px;background:#f5f1e8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;color:#1c1917;">
        <div style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 18px 45px rgba(28,25,23,0.12);">
          <div style="background:linear-gradient(135deg,#315c43 0%,#1f3f2f 100%);padding:32px 28px;text-align:center;">
            ...
            <div style="color:rgba(248,250,252,0.86);font-size:14px;">Você passará a receber avisos sobre novas respostas nesta thread específica.</div>
          </div>

          <div style="padding:28px;">
            <div style="font-size:16px;color:#334155;line-height:1.75;margin-bottom:20px;">
              Olá, <strong>${escapeHtml(subscriberName)}</strong>. Sua assinatura foi registrada com sucesso.
            </div>
            ...
            <div style="border:1px solid #d6e2da;background:#fbfdfc;border-radius:20px;padding:18px 20px;margin-bottom:24px;">
              ...
              <p style="margin:0 0 12px;color:#334155;line-height:1.75;">Sempre que alguém publicar uma nova resposta nesta thread, enviaremos um aviso para este email.</p>
              <p style="margin:0;color:#334155;line-height:1.75;">O descadastro continua disponível em todos os emails enviados para essa conversa.</p>
            </div>
            ...
            <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:16px;padding:14px 16px;font-size:13px;color:#9a3412;line-height:1.6;">
              Esta assinatura vale apenas para esta thread específica.
            </div>
          </div>

          <div style="padding:22px 28px;background:#fafaf9;border-top:1px solid #ece7de;text-align:center;">
            <div style="font-size:13px;font-weight:700;color:#44403c;margin-bottom:8px;">${escapeHtml(input.siteName)}</div>
            <div style="font-size:12px;color:#78716c;line-height:1.6;margin-bottom:12px;">Você pode parar de receber avisos desta conversa a qualquer momento.</div>
            <a href="${escapeHtml(input.unsubscribeUrl)}" style="font-size:12px;color:#57534e;text-decoration:underline;">Parar de receber emails desta conversa</a>
          </div>
        </div>
      </body>
      ...
      <body style="margin:0;padding:32px 16px;background:#f5f1e8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;color:#1c1917;">
        <div style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 18px 45px rgba(28,25,23,0.12);">
          <div style="background:linear-gradient(135deg,#315c43 0%,#1f3f2f 100%);padding:32px 28px;text-align:center;">
            ...
            <div style="color:rgba(248,250,252,0.86);font-size:14px;">Seu perfil no ${escapeHtml(input.siteName)} já está ativo.</div>
          </div>
          ...
          <div style="padding:28px;">
            ...
            <div style="background:#fbfdfc;border:1px solid #d6e2da;border-radius:20px;padding:18px 20px;margin-bottom:24px;">
              <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#315c43;margin-bottom:12px;">Recomendação</div>
              <p style="margin:0;color:#334155;line-height:1.75;">
                Entre no sistema e altere a senha assim que possível para manter sua conta protegida.
              </p>
            </div>
          ...
          <div style="padding:22px 28px;background:#fafaf9;border-top:1px solid #ece7de;text-align:center;">
            <div style="font-size:13px;font-weight:700;color:#44403c;margin-bottom:8px;">${escapeHtml(input.siteName)}</div>
            <div style="font-size:12px;color:#78716c;line-height:1.6;">Este email foi enviado automaticamente no momento da criação do usuário.</div>
          </div>
        </div>
      </body>
    </html>
...
export function buildArticleCategorySubscriptionSubject(
  ...
  return `Inscrição confirmada em ${input.categoryLabel} | ${input.siteName}`
}
    ...
    <html lang="pt-BR">
      ...
      <body style="margin:0;padding:32px 16px;background:#f5f1e8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;color:#1c1917;">
        <div style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 18px 45px rgba(28,25,23,0.12);">
          <div style="background:linear-gradient(135deg,#315c43 0%,#1f3f2f 100%);padding:32px 28px;text-align:center;">
            <div style="width:58px;height:58px;margin:0 auto 16px;border-radius:50%;background:rgba(255,255,255,0.14);display:flex;align-items:center;justify-content:center;font-size:28px;">🔔</div>
            <div style="color:#f8fafc;font-size:24px;font-weight:700;margin-bottom:8px;">Inscrição confirmada</div>
            <div style="color:rgba(248,250,252,0.86);font-size:14px;">Você receberá avisos sempre que um novo artigo for publicado nesta pasta.</div>
          </div>

          <div style="padding:28px;">
            <div style="font-size:16px;color:#334155;line-height:1.75;margin-bottom:20px;">
              Olá, <strong>${escapeHtml(subscriberName)}</strong>. Sua inscrição foi registrada com sucesso.
            </div>
            ...
            <div style="border:1px solid #d6e2da;background:#fbfdfc;border-radius:20px;padding:18px 20px;margin-bottom:24px;">
              ...
              <p style="margin:0;color:#334155;line-height:1.75;">Cada aviso trará as informações principais da publicação e um atalho para abrir o artigo no ${escapeHtml(input.siteName)}.</p>
            </div>
          ...
          <div style="padding:22px 28px;background:#fafaf9;border-top:1px solid #ece7de;text-align:center;">
            <div style="font-size:13px;font-weight:700;color:#44403c;margin-bottom:8px;">${escapeHtml(input.siteName)}</div>
            <div style="font-size:12px;color:#78716c;line-height:1.6;margin-bottom:12px;">Você pode cancelar essa inscrição a qualquer momento.</div>
      ...
      <body style="margin:0;padding:32px 16px;background:#f5f1e8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;color:#1c1917;">
        <div style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 18px 45px rgba(28,25,23,0.12);">
          <div style="background:linear-gradient(135deg,#315c43 0%,#1f3f2f 100%);padding:32px 28px;text-align:center;">
            ...
            <div style="color:rgba(248,250,252,0.86);font-size:14px;">Um novo conteúdo acabou de entrar em ${escapeHtml(input.categoryLabel)}.</div>
          </div>
          ...
          <div style="padding:28px;">
            ...
            <div style="background:#fbfdfc;border:1px solid #d6e2da;border-radius:20px;padding:18px 20px;margin-bottom:20px;">
              <div style="font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#315c43;margin-bottom:12px;">Por que você recebeu este email</div>
              <p style="margin:0;color:#334155;line-height:1.75;">Este aviso foi enviado porque seu email está inscrito para receber notificações de novas publicações em ${escapeHtml(input.categoryLabel)}.</p>
            </div>
          </div>

          <div style="padding:22px 28px;background:#fafaf9;border-top:1px solid #ece7de;text-align:center;">
            <div style="font-size:13px;font-weight:700;color:#44403c;margin-bottom:8px;">${escapeHtml(input.siteName)}</div>
            <div style="font-size:12px;color:#78716c;line-height:1.6;margin-bottom:12px;">Você pode continuar explorando esta pasta ou cancelar a inscrição quando quiser.</div>
