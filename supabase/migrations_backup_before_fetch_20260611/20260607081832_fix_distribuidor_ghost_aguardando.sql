-- =====================================================
-- DISTRIBUIDOR: remove "fantasmas" aguardando com usuario_atual preenchido
-- - tickets aguardando so contam/listam como livres quando usuario_atual IS NULL
-- - tickets em atendimento continuam visiveis na fila livres
-- =====================================================
...
BEGIN
  ...
  WHERE t.gse = ANY(v_gses)
    AND (
      ...
      (p_suspenso = false
        AND (
          (t.status = 'aguardando' AND t.suspenso = false AND t.usuario_atual IS NULL)
