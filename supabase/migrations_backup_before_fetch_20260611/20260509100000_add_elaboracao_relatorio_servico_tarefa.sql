-- =====================================================================
-- Migration: adiciona elaboracao_relatorio em Outros Servicos e Tarefas
-- Data: 2026-05-09
--
-- Objetivos:
--   1. Permitir registrar Outros Servicos do tipo elaboracao_relatorio.
--   2. Permitir criar/editar tarefas com o tipo elaboracao_relatorio.
--   3. Concluir tarefa desse tipo criando servico equivalente.
--   4. Contabilizar o novo tipo como horas nas estatisticas completas.
-- =====================================================================
...
COMMENT ON COLUMN public.servicos.tipo IS
  ...
  'elaboracao_relatorio, configuracao_sistema, lotacao_usuarios, cadastro_radar, '
