-- =====================================================
-- SMAX Global Robot - anexacao em lote com timeout proprio
-- Evita que a RPC herde o statement_timeout curto do role
-- PostgREST durante anexacoes maiores.
-- =====================================================
...
BEGIN
  ...
  IF to_regprocedure('public.tickets_sos_evaluate_trigger()') IS NOT NULL THEN
